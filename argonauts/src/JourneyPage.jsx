  ...
  const journeyPoints = [
    {
      ...
      correctAnswer: 'Jason',
      heroismText: 'The gathering of the Argonauts at Lemnos marks a shift in heroic ideals by prioritizing collective effort over solitary valor. Unlike Hercules, whose labors emphasized individual physical strength, Jason’s leadership in assembling a diverse crew—including figures like Atalanta, who defied gender norms—reflects a new model of heroism that values collaboration and inclusivity, challenging the traditional epic focus on a singular, divinely favored hero.',
    ...
    },
    {
      ...
      heroismText: 'Navigating the Symplegades underscores a redefinition of heroism through strategic intellect, akin to Odysseus’ “metis.” Jason’s use of a dove to gauge the rocks’ timing exemplifies cunning over brute force, contrasting with Hercules’ reliance on physical power. This episode illustrates how the Argonautica elevates intellectual prowess as a heroic virtue, aligning with a broader cultural shift toward valuing mental agility in epic narratives.',
    ...
    },
    {
      ...
      heroismText: 'By aiding Phineus against the Harpies, Jason demonstrates a heroic ethic of compassion and communal responsibility, diverging from Hercules’ focus on personal glory through physical feats. This act of mercy reflects a broader thematic shift in the Argonautica, where heroism encompasses moral duty and empathy, redefining the epic hero as a protector of the vulnerable rather than solely a conqueror of monsters.',
